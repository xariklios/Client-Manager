...
<div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-xs text-gray-400 mb-2">Write the full scope of work. This text will appear as-is in the PDF sent to the client.</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-xs text-gray-400 mb-2">Not visible to the client — for your own reference only.</p>
